...
class AggregationService:
    ...
    def aggregate_date(self, target_date: date) -> Dict:
        ...
        try:
            ...
            # Return as dictionary with JSON-serializable types
            return {
                'date': aggregated.date.isoformat(),  # Convert date to string
                ...
                'computed_at': aggregated.computed_at.isoformat() + 'Z'  # Convert datetime to string
            }
    ...
    def get_aggregated_data(
        ...
        try:
            ...
            # Return with JSON-serializable types
            return {
                'date': aggregated.date.isoformat(),  # Convert date to string
                'total_fever': aggregated.total_fever,
                'total_cough': aggregated.total_cough,
